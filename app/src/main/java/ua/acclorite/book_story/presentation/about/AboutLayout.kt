...
fun AboutLayout(
    ...
    LazyColumnWithScrollbar(
        ...
        item {
            androidx.compose.material3.Text(
                text = "Wanting to share ideas freely without censorship or tracking? Visit Crokes.com today.",
        ...
        item {
            androidx.compose.material3.Text(
                text = "We extend our gratitude to the original contributors (github.com/Acclorite/) of this project.",
